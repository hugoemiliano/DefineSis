...
namespace DefSis
{
    public partial class frmCadastroPec : Form
    {


        public frmCadastroPec()
        {
            InitializeComponent();
        }
        ...
        private void bt_salvar_Click(object sender, EventArgs e)
        {
            ...
            peca.IdPeca = Convert.ToInt32(tbCodigo.Text);
            peca.Peca = tbPeca.Text;
            peca.Obs = tbObs.Text;
            
            try
            {
                Pecas.Cadastrar(peca);
            ...
            {
                MessageBox.Show("Erro ao cadastrar dados da Peça : " + ex.Message, "Erro");
            }
        }
